...
import java.net.URL;
public class AtencionalclienteTest {
  ...
  public void atencionalcliente() {
    ...
    driver.findElement(By.id("email")).sendKeys("carlicortes2@hotmail.com");
    driver.findElement(By.id("passwd")).sendKeys("Titino140203");
    ...
    driver.findElement(By.id("message")).sendKeys("prueba ejercicio 2");
